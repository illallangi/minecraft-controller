...
async def presentation_configmap_idx(
    namespace,
    body,
    **_,
):
...
@kopf.on.probe(
    id=presentation_configmap_idx.__name__,
)
async def presentation_configmap_probe(
    presentation_configmap_idx: kopf.Index,
    **_,
):
    return {
        namespace: {
            o["metadata"]["name"]: o for o in presentation_configmap_idx[namespace]
        }
        for namespace in presentation_configmap_idx
    }
...
async def presentation_configmap(
    namespace,
    body,
    patch,
    **kwargs,
