...
async def application_dnsresourcerecord_idx(
    namespace,
    body,
    **_,
):
...
@kopf.on.probe(
    id=application_dnsresourcerecord_idx.__name__,
)
async def application_dnsresourcerecord_probe(
    application_dnsresourcerecord_idx: kopf.Index,
    **_,
):
    return {
        namespace: {
            o["metadata"]["name"]: o
            for o in application_dnsresourcerecord_idx[namespace]
        }
        for namespace in application_dnsresourcerecord_idx
    }
...
async def application_dnsresourcerecord(
    namespace,
    body,
    patch,
    **kwargs,
