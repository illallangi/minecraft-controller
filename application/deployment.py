...
def application_deployment_idx(
    namespace,
    body,
    **_,
):
...
@kopf.on.probe(
    id=application_deployment_idx.__name__,
)
def application_deployment_probe(
    application_deployment_idx: kopf.Index,
    **_,
):
    return {
        namespace: {
            o["metadata"]["name"]: o for o in application_deployment_idx[namespace]
        }
        for namespace in application_deployment_idx
    }
